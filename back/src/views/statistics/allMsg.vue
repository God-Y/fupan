...
import Search from "@/components/statistics/allSearch.vue";
import Tables from "@/components/statistics/allTable.vue";
@Component({
  components: {
    Search,
    Tables
...
export default class BackStatistics extends Vue {
  //发送http请求，获取数据。
  ...
  getList() {
    (this as any).$api.statistics
      .getList(this.statisticsForm, this.pages)
      .then((response: any) => {
